    ...
    return (
        <section className="relative min-h-screen flex flex-col justify-center items-center overflow-hidden bg-white">
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-4 text-center">
                {/* Main Hero Content */}
                <div className="mb-16 p-8 relative bg-black/90 backdrop-blur-lg border border-purple-300/30 rounded-2xl shadow-2xl overflow-hidden">
                    {/* Background Layer */}
                    <div
                    ...
                    <div className="relative z-10 text-center text-amber-50">
                        ...
                        <p className="text-xl md:text-2xl mb-8 text-amber-50 max-w-3xl mx-auto leading-relaxed font-semibold">
                            Saviya bridges the gap between care homes and compassionate sponsors —{" "}
                            <span className="font-semibold text-amber-50">
                                transparent, local, and impactful
                            </span>
                        </p>

                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <button className="px-8 py-4 bg-gradient-to-r from-purple-700 to-purple-800 text-white rounded-xl font-semibold text-lg hover:from-purple-800 hover:to-purple-900 transition-all duration-300 transform hover:scale-105 shadow-lg">
                                Become a Sponsor
                            </button>
                            <button className="px-8 py-4 bg-white/40 backdrop-blur-sm border border-purple-300 text-purple-700 rounded-xl font-semibold text-lg hover:bg-purple-700 hover:text-white transition-all duration-300 transform hover:scale-105 shadow-lg">
                                Explore Care Homes
                            </button>
                        </div>
                    </div>
